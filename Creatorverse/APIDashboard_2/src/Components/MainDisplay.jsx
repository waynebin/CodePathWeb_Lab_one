          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <thead>
              <tr>
                ...
                <th style={{ borderBottom: '1px solid #ccc', textAlign: 'right', paddingLeft: '1rem' }}>
                  Details
                </th>
              </tr>
            </thead>
            <tbody>
              {stocks.map(stock => (
                <tr key={stock.symbol}>
                  ...
                  <td style={{ padding: '0.5rem 0', textAlign: 'right', paddingLeft: '1rem'}}>
                    <Link to={`/detail/${stock.symbol}`} className="details-link">
                      <button style={{ backgroundColor: '#11d06d', color: 'white', border: 'none',
                         borderRadius: '5px', cursor: 'pointer', '&::hover': { backgroundColor: '#0056b3' } }}>View Details</button>
                    </Link>
                  </td>
                </tr>
              ))}
